...
def main():
    ...
    parser.add_argument('--img_dir',
                        ...
                        default='/workspace/84_cluster/mnt/cv_rsync/dataset/HifiFace/face_source',
                        help='Image file')
    ...
    model.CLASSES = ('female', 'male',
                     ...
                     'super_hq', 'hq', 'blur',
                     'nonhuman')
    with open('/workspace/84_cluster/mnt/cv_rsync/dataset/HifiFace/face_quality/image_attr_all_220107_epoch_21.txt',
              'a') as f1:
